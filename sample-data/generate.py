...
EXERCISES = [
    ...
    dict(id="ex-deadlift", name="Deadlift", muscleGroups=["back", "lower_back", "hamstring", "glutes"],
         metric=("reps", "kg"), effort="rir", kind="compound", warmup=(8, 60), base=100, inc=2.5, reps=(5, 5), sets=3),
    dict(id="ex-barbell-row", name="Barbell Row", muscleGroups=["back", "lats"],
         metric=("reps", "kg"), effort="rir", kind="compound", warmup=(10, 30), base=55, inc=1.0, reps=(10, 8), sets=3),
    dict(id="ex-pullup", name="Pull-up", muscleGroups=["lats", "back", "bicep"],
         metric=("reps", "none"), effort="rir", kind="bodyweight", base=6, inc=0.6, reps=(6, 6), sets=3),
    dict(id="ex-lat-pulldown", name="Lat Pulldown", muscleGroups=["lats", "back"],
         metric=("reps", "kg"), effort="rir", kind="isolation", base=50, inc=1.0, reps=(10, 8), sets=3),
    dict(id="ex-seated-cable-row", name="Seated Cable Row", muscleGroups=["back", "lats"],
